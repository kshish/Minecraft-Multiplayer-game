...
running = True
#Connect to the local game  already running Minecraft Pi and connectec to the world running on the core raspi.
mc = Minecraft.create()

#Connect to the raspi running the core script. Make sure to change below to proper ip address or hostname.
